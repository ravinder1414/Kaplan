...
import uiMap_KuPortalAdmin.LiveHelpPage;
...
public class LiveHelpPage_Nav {
	...
	public LiveHelpPage uiLiveHelpPageObjects;		
	...
	@Test
	public void verifyLiveHelpPage()
	{		
		
		uiHomePageObjects.lnkLiveHelp.click();
		uiLiveHelpPageObjects = new LiveHelpPage(driver);
		UserExtension.IsElementPresent(driver, uiLiveHelpPageObjects.tblLiveHelpConfig);		
		Assert.assertEquals(uiLiveHelpPageObjects.lblPageHeader.getText().trim(), uiLiveHelpPageObjects.sPageHeaderTxt, "Page Header is not as expected");
		Assert.assertTrue(uiLiveHelpPageObjects.tblLiveHelpConfig.isDisplayed(), "Live Help Configuration Table is not displayed");
	}
