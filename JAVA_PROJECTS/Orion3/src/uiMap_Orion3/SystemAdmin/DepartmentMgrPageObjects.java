...
public class DepartmentMgrPageObjects {
	
	public DepartmentMgrPageObjects(WebDriver driver) {
	...
	public String strNamePlateLeft = "KHE ORION 3 > System Admin > Department Manager";
