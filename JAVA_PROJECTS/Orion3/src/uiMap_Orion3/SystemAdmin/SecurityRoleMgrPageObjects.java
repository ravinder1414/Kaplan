...
public class SecurityRoleMgrPageObjects {
	
	public SecurityRoleMgrPageObjects(WebDriver driver) {
	...
	public String strNamePlateLeft = "KHE ORION 3 > System Admin > Security Role Manager";
