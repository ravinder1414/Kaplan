...
public class ActionResultsMgrFCDispositionPageObjects {
	
	public ActionResultsMgrFCDispositionPageObjects(WebDriver driver) {
	...
	public String strNamePlateLeft = "KHE ORION 3 > Ticket Admin > Action Results Manager - File Close Disposition";
