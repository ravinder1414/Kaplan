...
public class EmailTemplateMgrAdmPageObjects {

	public EmailTemplateMgrAdmPageObjects(WebDriver driver) {
	...
	public String strNamePlateLeft = "KHE ORION 3 > Ops Admin > Email Template Manager - Admissions";
